...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "DynamicPdfExample.Android.dll" comes first in this list. */
		"DynamicPdfExample.Android.dll",
		"DynamicPDF.HTMLConverter.NETStandard20.dll",
		"DynamicPdfExample.dll",
		"FormsViewGroup.dll",
